            ...
            <div className="postrow">
                ...
                <div className="postright">
                    <div className="tempcontainer">
                        <div className="font">Name of Product: {FeedUserPostObject.name}</div>
                        <div className="font">Product Description: {FeedUserPostObject.postDescription}</div>
                        <div className="font">Category: {FeedUserPostObject.postCategory}</div>
